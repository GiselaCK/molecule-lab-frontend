...
export default function BuilderScreen() {
  const { setScreen, setMolecule, setMoleculeAnalysis, admin } = useExperience();
  ...
  }, [builder.atoms, builder.bonds, admin.forceResult, setMolecule, setMoleculeAnalysis, setScreen]);
